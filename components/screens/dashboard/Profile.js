...
import { View, Text, ScrollView, TouchableOpacity, Image, TextInput, Platform, Alert} from "react-native";
...
const esquema = yup.object({
    ...
    password: yup.string().min(6,"El numero de caracteres minimos es 6").max(50,"El numero de caracteres maximos es 50").required("Contraseña obligatoria")
})
                ...
                {!cargando && (
                    <>
                        ...
                        <View style={styleprofile.viewInput}>
                            ...
                            />
                            {errors.nombre && <Text style={styleprofile.textoError}>{errors.nombre.message}</Text>}
                        </View>
                        ...
                        <View style={styleprofile.viewInput}>
                            ...
                            />
                            {errors.email && <Text style={styleprofile.textoError}>{errors.email.message}</Text>}
                        </View>
                        ...
                        <View style={styleprofile.viewInput}>
                            ...
                            />
                            {errors.password && <Text style={styleprofile.textoError}>{errors.password.message}</Text>}
                        </View>

                        <TouchableOpacity style={styleprofile.botonGuardar} onPress={handleSubmit(submit)}>
